> **Archival & Approval Record** — This Founder Review Dossier was approved **in part** by Shaphan, AskPIP Founder Authority. AF-1 and AF-2 were approved and adopted as the basis for the Dormancy Suitability Gate PKR, and AF-3 was approved and carried forward as a documented caveat rather than a blocking condition — all on 23 August 2026. §7.4 (ROC's own interaction/synthesis observation connecting AF-1–AF-3, not itself independently sourced) was **not approved as a direct finding**: per Evidence Assessment Standard §2.10 and ROC Operations Manual §8.4A, the Founder routed it to further research rather than adopting or excluding it outright (23 August 2026). That further research, **FRD-BUSHROSE-DORMANCY-02**, independently corroborated §7.4's substance, and its finding was itself approved and incorporated as **AF-4** on 9 September 2026. The approved information is now held in **ARC-BUSHROSE-DORMANCY-01** (`Knowledge Curation System/Mother Information Library/ARCs/ARC-BUSHROSE-DORMANCY-01.md`, Version 1.2). This document is preserved below exactly as submitted for Founder Review, per FRDS §5.3 (no alteration after completion) and MIL Standard's Information Integrity requirements. The "DRAFT — NOT APPROVED" banner immediately below reflects this document's status *at the time it was submitted for review*, not its current status — see this cover note for the current, approved-in-part status.
...
| Status | ~~Draft — submitted for Founder Review~~ **Approved in part 23 August 2026 (AF-1–AF-3); §7.4 routed to further research, corroborated and approved as AF-4 via FRD-BUSHROSE-DORMANCY-02 on 9 September 2026 — see Archival & Approval Record above** |
